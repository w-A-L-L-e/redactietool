...
class RmhMapping:
    ...
    def mh_to_form(self, token, pid, department, errors, mam_data):
        ...
        return {
            ...
            'titel_serie': get_property(mam_data, 'dc_title'),
            'titel_episode': get_property(mam_data, 'dc_title'),
            'titel_aflevering': get_property(mam_data, 'dc_title'),
            'titel_alternatief': get_property(mam_data, 'dc_title'),
            'titel_programma': get_property(mam_data, 'dc_title'),
            'titel_serienummer': get_property(mam_data, 'dc_title'),
            'titel_seizoen': get_property(mam_data, 'dc_title'),
            'titel_seizoen_nr': get_property(mam_data, 'dc_title'),
            'titel_archief': get_property(mam_data, 'dc_title'),
            'titel_deelarchief': get_property(mam_data, 'dc_title'),
            'titel_reeks': get_property(mam_data, 'dc_title'),
            'titel_deelreeks': get_property(mam_data, 'dc_title'),
            'titel_registratie': get_property(mam_data, 'dc_title'),
